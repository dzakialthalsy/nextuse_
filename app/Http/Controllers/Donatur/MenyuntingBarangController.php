...
class MenyuntingBarangController extends Controller
{
    /**
     * Menampilkan daftar barang (Inventory).
     * Use Case: Mengelola barang (Donatur)
     */
     ...
     * Use Case: Menyunting barang (Donatur)
     */
    public function edit(Request $request, $id)
    {
        ...
        $organizationId = $request->session()->get('organization_id');
        $item = Item::where('organization_id', $organizationId)
            ->where('is_draft', false)
            ->findOrFail($id);
    ...
    /**
     * Memperbarui status barang (AJAX).
     * Use Case: Mengelola barang (Donatur)
     */
    ...
    /**
     * Menghapus banyak barang sekaligus (AJAX).
     * Use Case: Mengelola barang (Donatur)
     */
