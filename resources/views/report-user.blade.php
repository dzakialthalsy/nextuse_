    ...
    <div class="min-h-[calc(100vh-180px)] bg-gradient-to-br from-teal-50 via-green-50 to-emerald-50 py-8 px-4 sm:px-6">
        <div class="max-w-[1200px] mx-auto">
            ...
            <nav class="mb-6 flex items-center gap-2 text-sm text-[#717182]">
                <a href="#" class="hover:text-neutral-950">Profil</a>
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
                <span class="text-neutral-950">Laporkan Pengguna</span>
            </nav>
                    ...
                    <div class="max-w-[640px] mx-auto">
                        ...
                        <div class="mb-8">
                            <div class="flex items-center gap-2 mb-3">
                                <h1 class="text-2xl font-semibold text-neutral-950">Laporkan Pengguna</h1>
                                <button type="button" class="text-[#717182] hover:text-neutral-950" title="Informasi">
                        ...
                        <!-- Form -->
                        <form action="{{ route('report-user.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="reportForm">
                            @csrf
                            
                            <!-- Target User - Readonly -->
                            <div class="space-y-2">
                                <label class="block text-sm text-neutral-950">Pengguna yang Dilaporkan</label>
                                <div class="flex items-center gap-3 p-4 rounded-lg border border-neutral-200 bg-[#f3f3f5]">
                                    ...
                                    <div>
                                        <p class="text-neutral-950 font-medium">{{ $targetUserName ?? 'Jane Doe' }}</p>
                                        <p class="text-sm text-[#717182]">{{ $targetUser ?? '@janedoe' }}</p>
                                    </div>
                                </div>
                                <input type="hidden" name="target_user" value="{{ $targetUser ?? '@janedoe' }}">
                                <input type="hidden" name="target_user_name" value="{{ $targetUserName ?? 'Jane Doe' }}">
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                >
                                    ...
                                    <option value="akun-palsu" {{ old('kategori') == 'akun-palsu' ? 'selected' : '' }}>Akun Palsu</option>
                            ...
                            <div class="flex items-center gap-2 p-4 rounded-lg bg-[#f3f3f5] border border-neutral-200">
                                ...
                                <p class="text-sm text-neutral-950">
                                    ...
                                    <a href="#" class="text-[#009689] hover:text-teal-700 underline">Kebijakan Komunitas</a>
                                    kami.
                                </p>
                            </div>
